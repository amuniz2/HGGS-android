...
import com.amlm.honeygogroceryshopping.tests.mocks.groceryfile.MyIosGroceryFileMock;
...
import com.google.inject.AbstractModule;
	...
	public class MyIosGroceryListsModule extends AbstractModule  {
		
		@Override
		protected void configure() {
			// TODO Auto-generated method stub
			bind(IGroceryFile.class).to(MyIosGroceryFileMock.class);
